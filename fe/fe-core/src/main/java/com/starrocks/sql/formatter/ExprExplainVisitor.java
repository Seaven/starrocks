...
/**
 * Expr2SQLVisitor is responsible for converting expression AST nodes back to SQL strings.
 * This class is designed to replace the toSql/toSqlImpl methods in Expr hierarchy.
 * <p>
 * All implementations are self-contained and do not call toSql/toSqlImpl methods.
 */
public class ExprExplainVisitor implements AstVisitorExtendInterface<String, Void> {
    public static String explain(Expr expr) {
        ExprExplainVisitor visitor = new ExprExplainVisitor();
    ...
    // ========================================= Literal Expressions =========================================
    @Override
    public String visitIntLiteral(IntLiteral node, Void context) {
    ...
    @Override
    public String visitLargeIntLiteral(LargeIntLiteral node, Void context) {
        return node.getStringValue();
    }
