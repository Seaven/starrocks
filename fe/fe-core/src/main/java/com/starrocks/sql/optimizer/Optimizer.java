...
public class Optimizer {
    ...
    private OptExpression logicalRuleRewrite(
        ...
        deriveLogicalProperty(tree);
        tree = extractCommonCTE(tree, rootTaskContext);
    ...
    private OptExpression extractCommonCTE(OptExpression tree, TaskContext rootTaskContext) {
        tree = new ReuseFusionPlanRule().rewrite(tree, rootTaskContext);
        deriveLogicalProperty(tree);
        rootTaskContext.setRequiredColumns(rootTaskContext.getRequiredColumns().clone());
        ruleRewriteOnlyOnce(tree, rootTaskContext, RuleSetType.PRUNE_COLUMNS);
        return tree;
    }
